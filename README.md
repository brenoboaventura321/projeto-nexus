...
- **Steam API Key:** Aceda a [Steam Community Dev](https://steamcommunity.com/dev) e crie uma chave de acesso.
- **Gemini API Key:** Aceda ao [Google AI Studio](https://ai.google.dev/) e gere uma chave de API para o seu projeto.
...
1. **Ligação:** O utilizador insere o seu identificador da Steam e clica em **🎮 Entrar**.
2. **Processamento Inicial:** O backend consulta a Steam, localiza o perfil, descarrega a biblioteca completa e armazena os dados.
3. **Interação:** O utilizador abre o chat geral ou clica no botão "Chat" de um jogo específico.
4. **Construção do Contexto RAG Inteligente:**
...
5. **Prompting:** O prompt do sistema instrui o Gemini a analisar subtilmente o perfil e a sugerir apenas os jogos disponíveis do catálogo filtrado, anexando a tag especial `[CARD: Nome do Jogo]`.
6. **Renderização Mágica:** O frontend interceta o texto da IA, remove a tag de texto cru e monta dinamicamente o cartão visual com o botão de carrinho verde integrado.
